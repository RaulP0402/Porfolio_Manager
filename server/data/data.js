...
export const kpis = [
  {
    ...
    capitol: "$100000.00",
    holdings: [
      { ticker: "BTC", quantity: "1.08", avgPurchasePrice: "$36962.4" },
      { ticker: "ETH", quantity: "17.23", avgPurchasePrice: "$2029.00" },
      { ticker: "SOL", quantity: "136.34", avgPurchasePrice: "$55.01"},
      { ticker: "USDC", quantity: "15000.00", avgPurchasePrice: "$1.00"},
      { ticker: "UNI", quantity: "1122.81", avgPurchasePrice: "5.70"}
    ],
    weeklyData: [
      { date: "2023-10-01", profit: "$0.00", loss: "$0.00" },
      { date: "2023-10-08", profit: "$0.00", loss: "$0.00" },
      { date: "2023-10-15", profit: "$0.00", loss: "$0.00" },
      { date: "2023-10-22", profit: "$0.00", loss: "$0.00" },
      { date: "2023-10-29", profit: "$0.00", loss: "$0.00" },

      { date: "2023-11-01", profit: "$0.00", loss: "$0.00" },
      { date: "2023-11-08", profit: "$0.00", loss: "$0.00" },
      { date: "2023-11-15", profit: "$0.00", loss: "$0.00" },
      { date: "2023-11-22", profit: "$0.00", loss: "$0.00" },
      { date: "2023-11-29", profit: "$0.00", loss: "$0.00" },

      { date: "2023-12-01", profit: "$3000.00", loss: "$0.00" },
      { date: "2023-12-08", profit: "$6400.00", loss: "$0.00" },
      { date: "2023-12-15", profit: "$6800.00", loss: "$0.00" },
      { date: "2023-12-22", profit: "$9800.00", loss: "$0.00" },
      { date: "2023-12-29", profit: "$13700.00", loss: "$0.00" },

      { date: "2024-01-01", profit: "$14900.00", loss: "$0.00" },
      { date: "2024-01-08", profit: "$9000.00", loss: "$0.00" },
      { date: "2024-01-15", profit: "$0.00", loss: "$1000.00" },
      { date: "2024-01-22", profit: "$0.00", loss: "$3200.00" },
      { date: "2024-01-29", profit: "$0.00", loss: "$4000.00" },

      { date: "2024-02-01", profit: "$12000.00", loss: "$0.00" },
      { date: "2024-02-08", profit: "$26000.00", loss: "$0.00" },
      { date: "2024-02-15", profit: "$32000.00", loss: "$0.00" },
      { date: "2024-02-22", profit: "$49000.00", loss: "$0.00" },
      { date: "2024-02-29", profit: "$55000.00", loss: "$0.00" },

      { date: "2024-03-01", profit: "$63000.00", loss: "$0.00" },
      { date: "2024-03-08", profit: "$70000.00", loss: "$0.00" },
      { date: "2024-03-15", profit: "$77000.00", loss: "$0.00" },
      { date: "2024-03-22", profit: "$87500.00", loss: "$0.00" },
      { date: "2024-03-29", profit: "$81000.00", loss: "$0.00" },
    ],
    monthlyData: [
      {
        month: "october",
        profit: "$0.00",
        loss: "$0.00",
        capitolAllocated: "$0.00",
      },
      {
        month: "november",
        profit: "$0.00",
        loss: "$0.00",
        capitolAllocated: "$77500.00",
      },
      {
        month: "december",
        profit: "$13700.00",
      ...
      },
      {
        ...
        profit: "$0.00",
        loss: "$4000.00",
        capitolAllocated: "$83900.00",
      },
      {
        month: "february",
        profit: "$55000.00",
        loss: "$0.00",
        capitolAllocated: "$88900.00",
      },
      {
        month: "march",
        profit: "$81000.00",
...
export const transactions = [
  {
    ...
    amount: "$40000.00",
    buyer: "Donovan Vanderpool",
    productIds: ["63bf7ac9f03239e002001600"]
  },
  {
    _id: "63bf7ccef032396a8e001696",
    amount: "$20000.00",
    buyer: "Morgan Leemaster",
    productIds: ["63bf7ac9f03239e002001601"]
  },
  {
    _id: "63bf7ccef03239e002001606",
    amount: "$15000.00",
    buyer: "Josh Perez",
    productIds: ["63bf7ac9f03239e002001602"]
  },
  {
    _id: "63bf7ccef03239aec900155b",
    amount: "$15000.00",
    buyer: "Raul Perez",
    productIds: ["63bf7ac9f03239e002001603"]
  },
  {
